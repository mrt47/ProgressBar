//
//  ProgressBarViewDraw.swift
//  ProgressBarFun
//
//  Created by Murat Kuran on 09/11/2017.
//  Copyright © 2017 muratkuran. All rights reserved.
//
...
public class ProgressBarViewDraw : NSObject {

    //// Drawing Methods

    @objc dynamic public class func drawProgressBar(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 16), progress: CGFloat = 159) {
        //// General Declarations
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }

        //// Color Declarations
        let devSlopes_Red = UIColor(red: 0.847, green: 0.278, blue: 0.118, alpha: 1.000)
